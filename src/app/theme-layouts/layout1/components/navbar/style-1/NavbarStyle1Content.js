  ...
  return (
    <Root className={clsx('flex flex-auto flex-col overflow-hidden h-full', props.className)}>
      ...
      >
        ...
        <div className="flex-col flex-0 flex items-center justify-center py-48 opacity-30">
          <img className="w-full max-w-64" src="assets/images/logo/logo-icon.png" alt="footer logo" />
          <p className='text-10'>© 2024 Spio. All rights reserved</p>
        </div>
      </StyledContent>
    </Root>
  );
