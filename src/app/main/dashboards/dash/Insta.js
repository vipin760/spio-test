    ...
    <div>
         <div className="relative w-full max-w-md h-64 lg:h-96">
              ...
              <div className="z-index z-0 absolute top-[90%] left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex flex-col items-center">
                <img
                  src="assets/images/dashboard/Insta.png"
                  alt="Google"
                  className="w-[30px] h-[30px] md:w-[40px] md:h-[40px]"
                />
                <span className="text-xs md:text-sm font-bold pb-[20px]">Instagram</span>
              </div>
            </div>

            <div className="flex justify-center items-center w-full mt-5">
              <div id="positive" className="mx-2 text-center">
                <span className="text-xl md:text-3xl " style={{color:"#5C9D4C"}}>5,432</span>
                <span className="text-xs md:text-sm text-gray-500 block">
                  Positive
                </span>
              </div>
              <div id="comments" className="mx-2 text-center">
                <span className="text-xl md:text-3xl " style={{color:"#FBB138"}}>364</span>
                <span className="text-xs md:text-sm text-gray-500 block">
                  Comments
                </span>
              </div>
              <div id="negative" className="mx-2 text-center">
                <span className="text-xl md:text-3xl "style={{color:"#065FD4"}}>541</span>
                <span className="text-xs md:text-sm text-gray-500 block">
                  Negative
                </span>
              </div>
