...
export const getOrganizations = createAsyncThunk(
  'projectDashboardApp/organizations/getOrganizations',
...
export const selectSearchText = ({ projectDashboardApp }) => projectDashboardApp?.organizations?.searchText;

export const { selectAll: selectOrganizations, selectById: selectOrganizationsById } =
  organizationsAdapter.getSelectors((state) => state.projectDashboardApp.organizations);
...
const organizationsSlice = createSlice({
  name: 'projectDashboardApp/organizations',
