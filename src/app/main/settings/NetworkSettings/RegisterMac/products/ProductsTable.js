...
function ProductsTable(props) {
    ...
    if (searchText.length !== 0) {
      setData(
        _.filter(products, (item) =>
          ...
          item?.wifiRegisteredMac?.toLowerCase().includes(searchText.toLowerCase())||item?.institutionBranchName?.toLowerCase().includes(searchText.toLowerCase())||
          item?.institutionGatewayDetailName?.toLowerCase().includes(searchText.toLowerCase()),
        ),
      )
      setPage(0)
    } else {
  ...
  function handleClick(item) {
    props.navigate(`/register_mac/${item.id}`)
  }
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell
                      ...
                      scope="row"
                    >
                      {n?.wifiRegisteredMacsStatus ? 'ACTIVE':'IN ACTIVE'}
                    </TableCell>
                  </TableRow>
                )
              })}
