...
function ProductsTable(props) {
    ...
    if (searchText.length !== 0) {
      setData(
        _.filter(products, (item) =>
          item.wifiSsid?.toLowerCase().includes(searchText.toLowerCase())||item?.institutionName?.toLowerCase().includes(searchText.toLowerCase())||item?.institutionBranchName?.toLowerCase().includes(searchText.toLowerCase()),
        ),
      )
      setPage(0)
    } else {
  ...
  function handleClick(item) {
    props.navigate(`/wifi_ssid/${item.id}`)
  }
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell
                      ...
                      scope="row"
                    >
                      {n?.wifiSsidStatus ? 'ACTIVE':'IN ACTIVE'}
                    </TableCell>
                  </TableRow>
                )
              })}
