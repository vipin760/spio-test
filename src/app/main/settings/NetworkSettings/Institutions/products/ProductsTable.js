...
function ProductsTable(props) {
  ...
  useEffect(() => {
   ...
   var endIndex = Math.min(startIndex + rowsPerPage - 1, totalItems - 1);
    ...
    dispatch(getInstitutes(params)).then(() => setDataFetched(true))
  }, [page,rowsPerPage])


  // useEffect(() => {
  //   dispatch(getInstitutes()).then(() => setDataFetched(true))
  // }, [dispatch])
  ...
  function handleClick(item) {
    props.navigate(`/institution/${item.id}`)
  }
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell
                      ...
                      align="right"
                    >
                      {n?.institutionIsActive ?'ACTIVE':'IN ACTIVE'}
                    </TableCell>
                  </TableRow>
                )
              })}
