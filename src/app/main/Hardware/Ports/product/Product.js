...
import WANPorts from './tabs/WANPorts'
import WLANPorts from './tabs/WLANPorts'
import {
  getProduct,
  newProduct,
  resetProduct,
...
import LANPorts from './tabs/LANPorts'
      ...
      <FusePageCarded
        ...
        content={
          <>
            ...
            >
              <Tab className="h-64" label="LAN Ports" />
              <Tab className="h-64" label="WAN Ports" />
              <Tab className="h-64" label="WLAN Ports" />
            </Tabs>
