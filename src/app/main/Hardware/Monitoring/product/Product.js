...
import OnlineStatus from './tabs/OnlineStatus'
import CpuStatus from './tabs/CpuStatus'
      ...
      <FusePageCarded
        ...
        content={
          <>
            ...
            >
              <Tab className="h-64" label="Device Online Status" />
              <Tab className="h-64" label="CPU Status" />
            </Tabs>
