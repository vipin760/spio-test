...
// import { getBranches } from '../../branches/store/productsSlice';
...
const schema = yup.object().shape({
  beds: yup
    .string()
    .required('You must enter a beds'),
...
export default withReducer('bedsApp', reducer)(Product);
